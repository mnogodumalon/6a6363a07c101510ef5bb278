...
interface WerkzeugverwaltungDialogProps {
  ...
  defaultValues?: Omit<Werkzeugverwaltung['fields'], 'kategorie' | 'zustand'> & {
...
export function WerkzeugverwaltungDialog({ open, onClose, onSubmit, defaultValues, recordId, enablePhotoScan = true, enablePhotoLocation = true }: WerkzeugverwaltungDialogProps) {
  ...
  const REQUIRED_FIELDS = ['bezeichnung', 'inventarnummer', 'kategorie', 'zustand'] as const;
  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'bezeichnung': (
      <div key="bezeichnung" className="space-y-1.5">
        ...
        <Input
          id="bezeichnung"
          placeholder="z. B. Akkubohrmaschine"
    ...
    'inventarnummer': (
      <div key="inventarnummer" className="space-y-1.5">
        <Label htmlFor="inventarnummer">Inventarnummer <span className="text-destructive" aria-hidden="true">*</span></Label>
        <Input
          id="inventarnummer"
      ...
      <div key="kategorie" className="space-y-1.5">
        ...
        >
          ...
          <SelectContent>
            ...
            <SelectItem value="leiter_geruestung">Leiter / Gerüst</SelectItem>
          </SelectContent>
        </Select>
    ...
    'naechste_pruefung': (
      <div key="naechste_pruefung" className="space-y-1.5">
        <Label htmlFor="naechste_pruefung">Nächste Prüfung</Label>
        <DatePicker
          id="naechste_pruefung"
          placeholder="Nächste Prüfung wählen"
          mode="date"
    ...
    'standort': (
      <div key="standort" className="space-y-1.5">
        ...
        <Input
          id="standort"
          placeholder="z. B. Werkstatt Regal B3"
    ...
    'anmerkungen': (
      <div key="anmerkungen" className="space-y-1.5">
        ...
        <Textarea
          id="anmerkungen"
          placeholder="Besonderheiten, Beschädigungen, Wartungshistorie..."
