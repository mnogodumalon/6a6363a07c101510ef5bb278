...
interface MitarbeiterverwaltungDialogProps {
  ...
  defaultValues?: Omit<Mitarbeiterverwaltung['fields'], 'abteilung'> & {
...
export function MitarbeiterverwaltungDialog({ open, onClose, onSubmit, defaultValues, recordId, enablePhotoScan = true, enablePhotoLocation = true }: MitarbeiterverwaltungDialogProps) {
  ...
  async function handleAiExtract(file?: File) {
    ...
    try {
      ...
      const schema = `{\n  "vorname": string | null, // Vorname\n  "nachname": string | null, // Nachname\n  "personalnummer": string | null, // Personalnummer\n  "abteilung": LookupValue | null, // Abteilung (select one key: "montage" | "installation" | "planung" | "lager" | "verwaltung" | "sonstiges") mapping: montage=Montage, installation=Installation, planung=Planung, lager=Lager, verwaltung=Verwaltung, sonstiges=Sonstiges\n  "telefon": string | null, // Telefonnummer\n  "email": string | null, // E-Mail-Adresse\n}`;
  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'abteilung': (
      <div key="abteilung" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="abteilung" className="max-sm:h-11"><SelectValue placeholder="Abteilung wählen" /></SelectTrigger>
          <SelectContent>
  ...
  const FIELD_LABELS: Record<string, string> = {"vorname": "Vorname", "nachname": "Nachname", "personalnummer": "Personalnummer", "abteilung": "Abteilung", "telefon": "Telefonnummer", "email": "E-Mail-Adresse"};
