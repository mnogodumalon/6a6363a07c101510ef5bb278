...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/werkzeug-ausleihen', label: 'Werkzeug ausleihen', icon: IconTool, description: 'Mitarbeiter wählen, Werkzeug zuweisen und Ausleihe anlegen' },
  { path: '/intents/werkzeug-rueckgabe', label: 'Werkzeug zurückgeben', icon: IconArrowBack, description: 'Rückgabe erfassen und bei Schaden Wartung anlegen' },
  // </custom:intents>
];
