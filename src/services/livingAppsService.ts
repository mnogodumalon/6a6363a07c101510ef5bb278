...
import type { Mitarbeiterverwaltung, Werkzeugverwaltung, AusleiheRueckgabe, WartungReparatur, CreateMitarbeiterverwaltung, CreateWerkzeugverwaltung, CreateAusleiheRueckgabe, CreateWartungReparatur } from '@/types/app';
...
export class LivingAppsService {
  ...
  static async getWerkzeugverwaltungEntry(id: string): Promise<Werkzeugverwaltung | undefined> {
    ...
    const record = { record_id: data.id, ...data } as Werkzeugverwaltung;
    return enrichLookupFields([record], 'werkzeugverwaltung')[0];
  }
  static async createWerkzeugverwaltungEntry(fields: CreateWerkzeugverwaltung) {
    return callApi('POST', `/apps/${APP_IDS.WERKZEUGVERWALTUNG}/records`, { fields: cleanFieldsForApi(fields as any, 'werkzeugverwaltung') });
  }
  static async updateWerkzeugverwaltungEntry(id: string, fields: Partial<CreateWerkzeugverwaltung>) {
    return callApi('PATCH', `/apps/${APP_IDS.WERKZEUGVERWALTUNG}/records/${id}`, { fields: cleanFieldsForApi(fields as any, 'werkzeugverwaltung') });
  }
  ...
  static async getAusleiheRueckgabe(): Promise<AusleiheRueckgabe[]> {
    ...
    return enrichLookupFields(records, 'ausleihe_&_rueckgabe');
  }
  static async getAusleiheRueckgabeEntry(id: string): Promise<AusleiheRueckgabe | undefined> {
    ...
    const record = { record_id: data.id, ...data } as AusleiheRueckgabe;
    return enrichLookupFields([record], 'ausleihe_&_rueckgabe')[0];
  }
  static async createAusleiheRueckgabeEntry(fields: CreateAusleiheRueckgabe) {
    return callApi('POST', `/apps/${APP_IDS.AUSLEIHE_RUECKGABE}/records`, { fields: cleanFieldsForApi(fields as any, 'ausleihe_&_rueckgabe') });
  }
  static async updateAusleiheRueckgabeEntry(id: string, fields: Partial<CreateAusleiheRueckgabe>) {
    return callApi('PATCH', `/apps/${APP_IDS.AUSLEIHE_RUECKGABE}/records/${id}`, { fields: cleanFieldsForApi(fields as any, 'ausleihe_&_rueckgabe') });
  }
  ...
  static async getWartungReparatur(): Promise<WartungReparatur[]> {
    ...
    return enrichLookupFields(records, 'wartung_&_reparatur');
  }
  static async getWartungReparaturEntry(id: string): Promise<WartungReparatur | undefined> {
    ...
    const record = { record_id: data.id, ...data } as WartungReparatur;
    return enrichLookupFields([record], 'wartung_&_reparatur')[0];
  }
  static async createWartungReparaturEntry(fields: CreateWartungReparatur) {
    return callApi('POST', `/apps/${APP_IDS.WARTUNG_REPARATUR}/records`, { fields: cleanFieldsForApi(fields as any, 'wartung_&_reparatur') });
  }
  static async updateWartungReparaturEntry(id: string, fields: Partial<CreateWartungReparatur>) {
    return callApi('PATCH', `/apps/${APP_IDS.WARTUNG_REPARATUR}/records/${id}`, { fields: cleanFieldsForApi(fields as any, 'wartung_&_reparatur') });
  }
